...
from app.routers.app_users import (app_crud, app_req_schema, app_res_schema) # noqa
from app.routers.app_users.app_users_res_doc import (  # Noqa
    create_app, delete_app, get_app, update_app)
...
async def put_app_user(
    ...
    try:
        await app_crud.update_app_user_info(user_id, user_token, **data)
