...
async def generates_invoice(
    ...
    try:
        await subscription_crud.generate_invoice(community_id, subscribtion_invoice_id, url)  # noqa
        return {
...
async def update_invoice(
    ...
    try:
        await subscription_crud.update_invoice(
            community_id, subscribtion_invoice_id, **data
        )  # noqa
        return {
